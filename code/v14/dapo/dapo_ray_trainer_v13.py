...
class RayDAPOTrainerV13(RayDAPOTrainerV11):
    ...
    def _build_dynamic_batch(self, current_weights: np.ndarray):
        ...
        initial_scores, initial_summary = self._v13_compute_candidate_scores(
        ...
        if final_peek["candidate_indices_by_category"] == initial_peek["candidate_indices_by_category"]:
            sample_scores, score_summary = initial_scores, initial_summary
        else:
            sample_scores, score_summary = self._v13_compute_candidate_scores(
